...
  // Create order and handle payment intent creation/confirmation
  const createOrderMutation = useMutation({
    mutationFn: orderService.createOrder,
    onSuccess: async (order) => {
      try {
        // Step 2: Order is created, now get the payment intent
...
        // Step 3: Confirm payment with Stripe immediately after getting the client secret
...
        }
      } catch (error) {
        toast.error('Failed to create payment intent or confirm payment.')
      } finally {
        setProcessing(false)
      }
    },
...
    // Step 1: Start the entire process by triggering the order creation mutation.
    // The rest of the logic is handled in the mutation's onSuccess callback.
